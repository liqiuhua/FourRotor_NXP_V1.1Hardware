...
void OLED_ShowNum(unsigned char x,unsigned char y,signed int number);
void OLED_Num(uint8_t x,uint8_t y,int16_t asc) ;
void OLED_Showplus(uint8_t x,uint8_t y);
