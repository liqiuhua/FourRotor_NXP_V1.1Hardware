...
#define  DMA_IRQ_EN(DMA_CHn)    NVIC_EnableIRQ((IRQn_Type)((DMA_CHn) + 0))                         //允许DMA通道传输
#define  DMA_IRQ_DIS(DMA_CHn)   NVIC_DisableIRQ((IRQn_Type)((DMA_CHn) + 0))                        //禁止DMA通道传输
...
void DMA_count_Init(DMA_CHn CHn, PTxn ptxn, uint32 count, DMA_PORTx2BUFF_cfg cfg);
